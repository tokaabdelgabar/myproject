...
(function($) {
  ...
  $.fn.raty.defaults = {
    ...
    half         : false,
    halfShow     : true,
    hints        : ['Mangelhaft', 'Ausreichend', 'Befriedigend', 'Gut', 'Sehr Gut'],
    iconRange    : undefined,
    mouseout     : undefined,
    mouseover    : undefined,
    noRatedMsg   : 'Not rated yet!',
